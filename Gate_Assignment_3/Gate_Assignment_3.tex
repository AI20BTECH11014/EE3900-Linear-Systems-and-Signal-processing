...
\begin{lstlisting}
https://github.com/AI20BTECH11014/EE3900-Linear-Systems-and-Signal-processing/blob/main/Gate_Assignment_3/Gate_Assignment_3.tex
\end{lstlisting}
%
Download all python codes from
\begin{lstlisting}
https://github.com/AI20BTECH11014/EE3900-Linear-Systems-and-Signal-processing/blob/main/Gate_Assignment_3/Gate_Assignment_3.py
\end{lstlisting}
...
\begin{align}
    ...
    x\brak{\frac{t}{3}}&\fourier{3}X\brak{3f} \label{1}
\end{align}
By the time shifting property of Fourier transform,
\begin{align}
    e^{-j2\pi f_0t}x\brak{t}&\fourier{X\brak{f + f_0}}\\
    e^{\frac{-j4\pi t}{3}}x\brak{t}&\fourier{X\brak{f + \frac{2}{3}}}
\end{align}
using \eqref{1},
\begin{align} 
   e^{\frac{-j4\pi t}{3}}x\brak{\frac{t}{3}}&\fourier{3}X\brak{3\brak{f + \frac{2}{3}}}\\
